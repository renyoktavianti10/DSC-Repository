...
db = sqlite3.connect('/Users/renyoktavianti/miniconda3/envs/DSC-Repository/Challange GOLD/tweet.db', check_same_thread = False)
...
@swag_from("/Users/renyoktavianti/miniconda3/envs/DSC-Repository/Challange GOLD/docs/input_data.yml", methods=['POST'])
@app.route('/input_data', methods=['POST']) #endpoint
def test ():
...
@swag_from("/Users/renyoktavianti/miniconda3/envs/DSC-Repository/Challange GOLD/docs/upload_data.yml", methods=['POST'])
